...
class ChatsTableViewController: UITableViewController {
    ...
    @IBAction func composeBarButtonPressed(_ sender: Any) {
        let userView = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "usersView") as! UserTableViewController
    ...
    private func filteredContentForSearchText(searchText: String) {
        filteredRecents = allRecents.filter { recent -> Bool in
            ...
            recent.receiverName.lowercased().contains(searchText.lowercased())
        }
